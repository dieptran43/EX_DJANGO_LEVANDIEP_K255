	...
	if request.method == 'POST':
		...
		if form.is_valid():
			...
			for item in cart:
				...
				chuoi_don_hang+='<tr><td rowspan="4"><img src="http://127.0.0.1:8000'+item['product'].product_image.url+'" width="250px"></td>'
				chuoi_don_hang+='<td>Sản phẩm</td><td>'+item['product'].product_name+'</td></tr>'
